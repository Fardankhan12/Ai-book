        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link href="/chatkit" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700 flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  <path d="M2 5.5A2.5 2.5 0 014.5 3h11A2.5 2.5 0 0118 5.5v4A2.5 2.5 0 0115.5 12H7.7L4 15.2V12.5A2.5 2.5 0 012 10.5v-5z" />
                </svg>
                <span>Chat</span>
              </Link>
